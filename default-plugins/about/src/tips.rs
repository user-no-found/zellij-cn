...
impl Page {
    ...
    pub fn tip_1(link_executable: Rc<RefCell<String>>) -> Self {
        Page::new()
            ...
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(Text::new("访问链接：").color_range(2, ..))),
    ...
    pub fn tip_2(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Self {
        Page::new()
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::new("你可以在 $EDITOR 中打开终端内容，以便搜索")
                                .color_range(2, 43..=49)
                    ))
                ]),
                ComponentLine::new(vec![
    ...
    fn tip_4(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            ...
            .with_bulletin_list(
                BulletinList::new(
                    Text::new(format!("浮动窗格可被“钉住”：")).color_range(2, ..),
                )
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
    ...
    pub fn tip_5(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::new("窗格可通过缩放形成堆叠，便于管理。"))),
                ]),
            ])
            .with_bulletin_list(BulletinList::new(Text::new("可这样体验：").color_range(2, ..))
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
    ...
    pub fn tip_6(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::new("Zellij 快捷键是否与你的其他应用冲突？")))
                ]),
            ])
            .with_bulletin_list(BulletinList::new(Text::new("试试无冲突快捷键预设："))
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            match *base_mode.borrow() {
                                InputMode::Locked => {
                    ...
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::new("按 TAB 进入 Change Mode Behavior")
                                .color_range(3, 6..=9)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
    ...
    pub fn tip_8(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            ...
            .with_paragraph(vec![
                ...
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::new("屏幕左右边缘，将会聚焦到下一个或上一个标签页。")))
                ]),
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(support_the_developer_text())),
    ...
    pub fn tip_10(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            ...
            .with_bulletin_list(
                BulletinList::new(
                    Text::new("Zellij 会话管理器可以：").color_range(2, 11..=25),
                )
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::new(
                        "创建新会话",
            ...
            .with_paragraph(vec![ComponentLine::new(vec![ActiveComponent::new(
                TextOrCustomRender::Text(
                    Text::new("你也可以将它作为欢迎页：zellij -l welcome")
                        .color_range(0, 46..=62),
                ),
            )])])
            .with_paragraph(vec![ComponentLine::new(vec![
    ...
    pub fn tip_12(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            ...
            .with_paragraph(vec![
                ...
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            match *base_mode.borrow() {
                                InputMode::Locked => {
                                    Text::new("可通过以下快捷键打开：Ctrl g + o + p")
                                        .color_range(3, 24..=29)
                                        .color_indices(3, vec![33, 37])
                                },
                                _ => {
                                    Text::new("可通过以下快捷键打开：Ctrl o + p")
                                        .color_range(3, 24..=29)
                                        .color_indices(3, vec![33])
                                }
                            }
            ...
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(Text::new("了解更多插件信息：").color_range(2, ..))),
